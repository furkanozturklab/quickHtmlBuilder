...
<head>
    ...
    <script src="https://kit.fontawesome.com/8111bcdbe8.js" crossorigin="anonymous"></script>
    ...
    <section class="step-section">
        <div class="step-card">
            <div class="step-content">
                ...
                <div id="step1" class="step-front">

                    <div class="step-body content-center">
                        <div class="step-ico"> <i class="fa-solid fa-person-digging"></i> </div>
                        ...
                        <div class="step-button">
                            <button onclick="nextStep(1)"> <i class="fa-solid fa-arrow-right-long"></i> Başla </button>
                        </div>
                    </div>
                    <div class="step-info">
                            ...
                            <div class="item-right col-9">
                                ...
                                <div class="chexkbox-group col-12">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label class="form-check-label" for="exampleCheck1">Metatag</label>
                                    ...
                                    <div class="check-item">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">Viewport</label>
                                    ...
                                    <div class="check-item">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">Responsive</label>
                                    ...
                                    <div class="check-item">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">Charset UTF-8</label>
                ...
                <div id="step4" class="step-front active">
                    ...
                    <div class="step-body">
                        ...
                        <div class="log-panel">
                            ...
                            <span class="dark"> [30-03-2022 19:33:34] - Builder start </span>
